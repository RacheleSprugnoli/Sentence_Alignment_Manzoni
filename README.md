...
- parallel texts of Chapter VIII of both _Ventisettana_ and _Quarantana_ aligned at sentence level to 11 English translations.  Each chapter is saved as two independent XML files (one for the Italian text and one for the English translation) and their alignment is exported as a separate XML file containing pointers to the individual sentences of the two texts: this alignment files can be imported into InterText.
